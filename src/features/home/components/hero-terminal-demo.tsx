...
const API_DEMOS: ApiDemoConfig[] = [
  {
    ...
    label: 'Chat',
    method: 'POST',
    endpoint: 'https://mckj.zeabur.app/v1/chat/completions',
  ...
  },
  {
    ...
    label: 'Responses',
    method: 'POST',
    endpoint: 'https://mckj.zeabur.app/v1/responses',
    headers: ['"Authorization: Bearer sk-your-api-key"'],
    request: ['"model": "gpt-4.1-mini",', '"input": "生成一段摘要"'],
    response: [
      '{',
  ...
  },
  {
    ...
    label: 'Claude',
    method: 'POST',
    endpoint: 'https://mckj.zeabur.app/v1/messages',
    headers: [
  ...
  },
  {
    ...
    label: 'Gemini',
    method: 'POST',
    endpoint: 'https://mckj.zeabur.app/v1beta/models/{model}:generateContent',
  ...
  return (
    <div className={cn('mx-auto w-full max-w-2xl', props.className)}>
      ...
      >
        ...
        {/* Fixed rows keep the panel stable when switching demos. */}
